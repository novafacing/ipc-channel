...
fn simple() {
    ...
    let (received_data, received_channels, received_shared_memory, descriptors) =
        rx.recv().unwrap();
    assert_eq!(
        (
            &received_data[..],
...
fn receiver_set() {
    ...
    let (received_id, received_data, _, _, _) = rx_set
        .select()
        .unwrap()
        .into_iter()
        .next()
...
fn shared_memory() {
    ...
    let (received_data, received_channels, received_shared_memory, received_descriptors) =
        rx.recv().unwrap();
